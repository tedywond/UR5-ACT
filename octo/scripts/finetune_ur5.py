...
# set TFDS_DATA_DIR
import os
os.environ['TFDS_DATA_DIR'] = '/code/src/ur5-octo/datasets'
...
flags.DEFINE_string("data_dir", "/code/src/ur5-octo/datasets", "Path to finetuning dataset, in RLDS format.")
flags.DEFINE_string("save_dir", "/code/src/ur5-octo/finetuned/0424", "Directory for saving finetuning checkpoints.")
flags.DEFINE_integer("batch_size", 16, "Batch size for finetuning.")  # Confirmed 32 works for elm
...
def main(_):
    ...
    dataset = make_single_dataset(
        ...
        traj_transform_kwargs=dict(
            window_size=2,
            future_action_window_size=4,  # so we get 50 actions for our action chunk
        ),
